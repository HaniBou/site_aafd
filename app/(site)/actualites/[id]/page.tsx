...
export default function ActualiteDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // NOTE : J'ai supprimé le bloc "if (!actualite)" ici pour qu'il ne bloque pas l'affichage global
    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="py-12 md:py-16">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          ...
          {!actualite ? (
            /* CAS INTROUVABLE : Intégré dans la structure */
            <div className="py-16 text-center">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Actualité introuvable</h2>
                <p className="text-gray-600 mb-8">Cette actualité n'existe pas ou a été supprimée.</p>
            </div>
          ) : (
            /* CAS SUCCÈS : Affichage de l'article */
            <div className="mb-8">
                {/* Titre de l'article */}
                <h2 className="font-extrabold text-gray-900 mb-6 text-center md:text-left">{actualite.title}</h2>
  ...
  /* On ajoute flex et justify-center par défaut, puis justify-start sur écran moyen */
    ...
    >
      ...
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          {/* Bouton retour en bas : Toujours visible sous la condition */}
      ...
      {/* CTA Instagram - Toujours présent */}
