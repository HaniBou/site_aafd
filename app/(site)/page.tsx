...
export const metadata: Metadata = {
  ...
  description: "L'AAFD accompagne les familles réfugiées sur le Val de Saône depuis 19 ans : vente de plats cuisinés, événements festifs, cours de français et aide matérielle. 100% bénévoles.",
  alternates: {
    canonical: '/',
  },
  openGraph: {
