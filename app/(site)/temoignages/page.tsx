...
export default function TemoignagesPage() {
  ...
  const familyFallbacks = [
    {
      container: "bg-gradient-to-br from-blue-100 to-blue-200 text-blue-300",
      quote: "text-blue-900",
    },
    {
      container: "bg-gradient-to-br from-orange-100 to-orange-200 text-orange-300",
      quote: "text-orange-600",
    },
    {
      container: "bg-gradient-to-br from-green-100 to-green-200 text-green-300",
              ...
              {familles.map((item, index) => {
                ...
                return (
                  <article key={item.id} className="grid gap-8 md:grid-cols-2 items-center">
                    <div
                      className={`relative h-[400px] rounded-2xl overflow-hidden shadow-xl ${style.container} ${
