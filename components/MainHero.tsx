...
export function MainHero() {
  ...
  return (
    <section ref={containerRef} className="relative h-[100svh] flex flex-col justify-end overflow-hidden">
      {/* Image de fond */}
      ...
      {/* Contenu principal */}
      <motion.div style={{ y: y1, opacity }} className="relative z-20 pb-16 md:pb-24">
        <div className="mx-auto max-w-screen-2xl px-8 md:px-16">
          ...
          <motion.div
            ...
            className="w-16 h-0.5 bg-orange-500 mb-6"
            style={{ originX: 0 }}
          />
          ...
          <motion.div
            ...
            className="flex items-start gap-6 max-w-lg mb-10"
          >
          ...
          >
            <Link
              href="/nous-rejoindre"
              className="inline-flex items-center justify-center gap-2 px-8 py-3.5 text-base font-bold rounded-full bg-gradient-to-r from-orange-400 to-orange-500 text-white hover:from-orange-500 hover:to-orange-600 transition-all shadow-xl hover:shadow-2xl hover:scale-105"
            >
              Devenir bénévole
            </Link>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3.5 text-base font-bold rounded-full bg-gradient-to-r from-pink-500 to-pink-600 text-white hover:from-pink-600 hover:to-pink-700 transition-all shadow-xl hover:shadow-2xl hover:scale-105"
            >
              Faire un don
      ...
      <motion.div
        ...
        className="absolute bottom-10 right-10 z-30 flex flex-col items-center gap-3"
      >
