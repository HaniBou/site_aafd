  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        <div>
          <h2 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Plats de la vente</h2>
      ...
      {plats.length === 0 ? (
        ...
        <div className="space-y-3">
          {plats.map(plat => (
            <div key={plat.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
              <div className="flex gap-0">
                ...
                <div className="flex-1 p-4 min-w-0">
                  {plat.typeMenu && (
                    <span className="inline-block text-xs font-semibold text-orange-700 bg-orange-50 px-2.5 py-0.5 rounded-full border border-orange-100 mb-1.5">
                      {plat.typeMenu}
                    </span>
                  )}
